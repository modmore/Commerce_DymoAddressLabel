...
if (!createObject('modNamespace',array(
    'name' => 'commerce_dymoaddresslabel',
    'path' => $componentPath.'/core/components/commerce_dymoaddresslabel/',
    'assets_path' => $componentPath.'/assets/components/commerce_dymoaddresslabel/',
),'name', false)) {
    echo "Error creating namespace commerce_dymoaddresslabel.\n";
}

/* Path settings */
if (!createObject('modSystemSetting', array(
    'key' => 'commerce_dymoaddresslabel.core_path',
    'value' => $componentPath.'/core/components/commerce_dymoaddresslabel/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_dymoaddresslabel',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_dymoaddresslabel.core_path setting.\n";
}

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_dymoaddresslabel.assets_path',
    'value' => $componentPath.'/assets/components/commerce_dymoaddresslabel/',
    'xtype' => 'textfield',
    'namespace' => 'commerce_dymoaddresslabel',
    'area' => 'Paths',
    'editedon' => time(),
), 'key', false)) {
    echo "Error creating commerce_dymoaddresslabel.assets_path setting.\n";
}
...
$assetsUrl = "{$requestUri}assets/components/commerce_dymoaddresslabel/";

if (!createObject('modSystemSetting', array(
    'key' => 'commerce_dymoaddresslabel.assets_url',
    'value' => $assetsUrl,
    'xtype' => 'textfield',
    'namespace' => 'commerce_dymoaddresslabel',
    'area' => 'Paths',
...
foreach ($settings as $key => $opts) {
    ...
    if (!createObject('modSystemSetting', array(
        'key' => 'commerce_dymoaddresslabel.' . $key,
        'value' => $opts['value'],
        'xtype' => $xtype,
        'namespace' => 'commerce_dymoaddresslabel',
        'area' => $opts['area'],
...
include $componentPath . '/core/components/commerce_dymoaddresslabel/vendor/autoload.php';

// Grab the path to our namespaced files
$modulePath = $componentPath . '/core/components/commerce_dymoaddresslabel/src/Modules/';

// Instruct Commerce to load modules from our directory, providing the base namespace and module path twice
$commerce->loadModulesFromDirectory($modulePath, 'modmore\\Commerce\\DymoAddressLabel\\Modules\\', $modulePath);
